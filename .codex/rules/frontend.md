...
- Не змішуй мережеві запити, розрахунки й масову DOM-логіку в одному обробнику події.
...
- Будь-яка візуальна зміна узгоджується з `DESIGN.md`.

## Перевірка

Після UI-зміни виконай `npm run build` і перевір цільову сторінку та один відповідний користувацький сценарій.
