...
Система призначена для автоматизації роботи гемологів, ведення експертних
звітів, системного розрахунку частини IDC-параметрів і фіксації приватних
довідкових ринкових орієнтирів із provenance. ML-модель не реалізована і не
використовується для ціни або експертного висновку.
...
- [x] **Незмінність historical grades:** старий bulk-backfill вилучено; зміна
  методики потребує нової версії ruleset та окремо погодженого read-only
  порівняння, а не переписування виданих звітів.
...
- [x] **Public Passport:** Для виданого звіту admin може опублікувати revocable код, посилання й QR та завантажити allow-listed PDF-паспорт. Гість перевіряє лише чинну публічну проєкцію без ціни, коментарів і private media.
