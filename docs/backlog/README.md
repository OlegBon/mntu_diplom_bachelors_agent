...
| P1 | [167-synthetic-demo-dataset-date-boundary-renewal.md](./167-synthetic-demo-dataset-date-boundary-renewal.md) | Backup-gated v2 renewal: правильний діапазон дат без зміни operational `DR-*`. |
