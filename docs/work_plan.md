...
| `/statistics/expert-performance` | Admin-only operational snapshot експертів; окремий analytics UI — лише після ручної перевірки контракту. |
...
- [ ] [108 — Контракт статистики експертів](./backlog/108-expert-statistics-and-analytics-contract.md): усунуто 500, зафіксовано all-time status-агрегати та admin RBAC; після ручної перевірки вирішити, чи потрібен окремий analytics UI.
