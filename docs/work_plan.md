...
- [ ] [040 — Ядро звіту й довідники](./backlog/040-report-core-and-reference-data.md): стани, дані каменю, валідація й серверні mappings. План безпечного backfill та сумісності зафіксовано в [ADR-003](./decisions/003-report-core-migration-plan.md).
