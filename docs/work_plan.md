...
- [ ] [113 — Час від початку майстра до першого збереження](./backlog/113-wizard-first-save-time.md): окремо виміряти лише успішні створення чернеток; не змішувати метрику з active time вже створеного звіту.
