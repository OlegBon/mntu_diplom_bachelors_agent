...
- [ ] [105 — Версії правил IDC і довідників оцінювання](./backlog/105-versioned-reference-catalogs.md): матриця відповідності й меж `idc-demo-v1`, одне джерело expert grades, immutable ruleset та versioned catalogs для нових reports без зміни historical reports, паспортів або PDF.
