...
- [ ] [131 — Зображення у PDF публічного паспорта](./backlog/131-public-passport-pdf-media.md): додати до on-demand PDF лише явно опубліковані фото каменю та plotting, з allow-list/checksum/revoke гарантіями, layout на A4 і PDF-тестами.
