...
- [ ] [040 — Ядро звіту й довідники](./backlog/040-report-core-and-reference-data.md): код, API, тести й Alembic `0002_report_core` готові; застосування до цінної локальної MariaDB, перевірка backfill і фіналізація задачі очікують окремого підтвердження. План сумісності — в [ADR-003](./decisions/003-report-core-migration-plan.md).
