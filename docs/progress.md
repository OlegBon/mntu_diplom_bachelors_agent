...
- **Результат:** у tablet-діапазоні таблиця переходить у картки з підписами полів, тому колонки не стискаються й не виходять за межі блока; desktop і mobile presentation не змінені.
